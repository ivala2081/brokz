/**
 * AccountForm — /dashboard/account.
 *
 * Two sections:
 *   1. Profile — full_name, phone (editable). Email is read-only.
 *   2. Password change — via supabase.auth.updateUser().
 *
 * Uses Field + Input + Button primitives. React Hook Form + Zod.
 */
...
export default function AccountForm({ locale: localeProp = 'tr' }: { locale?: Locale }) {
