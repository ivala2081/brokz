...
export function GLSLHills({ cameraZ = 125, planeSize = 256, speed = 0.5 }: GLSLHillsProps) {
                    ...
                    new THREE.RawShaderMaterial({
                        ...
                        fragmentShader: `
                            ...
                            void main(void) {
                                ...
                                float opacity = clamp((96.0 - dist) / 200.0, 0.0, 1.0);

                                float t = clamp((vPosition.y + 10.0) / 55.0, 0.0, 1.0);
                                vec3 colorBase   = vec3(0.0,  0.55, 0.15);
                                vec3 colorAccent = vec3(0.37, 0.87, 0.51);
                                vec3 color = mix(colorBase, colorAccent, t);

                                gl_FragColor = vec4(color, opacity * 0.38);
                            }
                        `,
                        transparent: true,
                    })
