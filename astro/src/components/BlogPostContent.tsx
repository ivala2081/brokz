...
import TracingBeam from './fx/TracingBeam';
import { categoryLabels, type BlogPost } from '../lib/blog';
        ...
        <>
            <section className="relative bg-surface-inverse text-white overflow-hidden">
                ...
                <div className="relative max-w-[820px] mx-auto px-6 pt-24 md:pt-32 pb-20 md:pb-28">
                    ...
                    <motion.p
                        className="text-gray-400 text-sm pt-6 border-t border-line-inverse inline-block"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
            ...
            <section className="section-padding bg-surface">
                ...
                prose-hr:border-line"
                        ...
                        <div className="mt-20 pt-10 border-t border-line">
                            <a href="/blog" className="inline-flex items-center gap-2 text-sm font-semibold text-ink-muted hover:text-brand transition-colors">
